...
5. После успешного создания БД, внести имя входа(пользователя БД) в роль functionalityRole.
6. Запускаем образ на сервере через консоль:
...
7. Для остановки работы контейнера необходимо выполнить цепочку команд:
